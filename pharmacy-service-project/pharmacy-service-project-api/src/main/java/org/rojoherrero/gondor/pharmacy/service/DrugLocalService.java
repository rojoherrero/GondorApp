...
public interface DrugLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DrugLocalServiceUtil} to access the drug local service. Add custom service methods to {@link org.rojoherrero.gondor.pharmacy.service.impl.DrugLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Drug> getDrugsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Drug fetchDrugByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Drug getDrugByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
